// LocalLoop verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'localloop-pepper-7q4w2z';

const FILES = [
  '01-localloop-system.pdf', '02-hardware-tiers.pdf', '03-model-picker.pdf', '04-context-pack.pdf', '05-voice-contract.pdf', '06-loop-builder.pdf', '07-runlog-trustgate.pdf', '08-localloop-playbook.pdf',
];
